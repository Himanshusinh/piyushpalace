...
export default function HeritageAboutSection() {
  ...
  return (
    <section id="about" className="py-24 bg-[#F3EFE9] dark:bg-[#0E0F17] text-neutral-900 dark:text-amber-50 relative overflow-hidden border-t border-amber-500/15 transition-colors duration-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative">
            ...
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs uppercase font-serif text-amber-700 dark:text-amber-300 font-semibold tracking-wider flex items-center gap-2">
                <Crown className="w-4 h-4 text-amber-500 dark:text-amber-400" />
                <span>Authentic Piyush Palace Estate</span>
              </span>

              <div className="flex items-center gap-1.5 bg-white/80 dark:bg-black/60 border border-amber-500/30 p-1 rounded-full text-xs shadow-md">
                <button
                  onClick={() => setActiveTab("day")}
                  className={`flex items-center gap-1.5 px-3 py-1 rounded-full font-serif transition-all ${
                    activeTab === "day"
                      ? "bg-amber-500 text-black font-bold shadow-md"
                      : "text-neutral-700 dark:text-amber-200/70 hover:text-black dark:hover:text-amber-100"
                  }`}
                >
            ...
            {/* Main Showcase Image */}
            <div className="relative z-10 rounded-3xl overflow-hidden border-2 border-amber-500/40 shadow-2xl shadow-black/40 group">
              <Image
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 royal-glass-card rounded-2xl border border-amber-500/40">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-amber-500/20 flex items-center justify-center text-amber-500 dark:text-amber-400 shrink-0">
                      <Crown className="w-5 h-5" />
                    </div>
                    <div>
                      <h4 className="font-serif text-sm font-bold text-neutral-900 dark:text-amber-200">
                        {activeTab === "day" ? "Piyush Palace 7-Acre Estate Grounds" : "Illuminated Royal Sandstone Facade"}
                      </h4>
                      <p className="text-xs text-neutral-700 dark:text-amber-100/70">Authentic Red Sandstone Palacial Architecture in Goblej</p>
                    </div>
                  </div>
                  <span className="text-[10px] bg-amber-500/20 text-amber-800 dark:text-amber-300 font-serif border border-amber-500/40 px-2.5 py-1 rounded-full uppercase">
                    Official Photo
                  </span>
                </div>
              </div>
            ...
            <div className="hidden sm:block absolute -bottom-6 -right-6 z-20 w-64 royal-glass-card p-5 rounded-2xl border border-amber-500/40 shadow-2xl backdrop-blur-xl">
              ...
              <p className="text-xs text-neutral-700 dark:text-amber-200/80 leading-relaxed">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-base text-neutral-700 dark:text-amber-100/80 leading-relaxed font-light">
              Located at Goblej on the Bareja-Kheda Highway (NH-8), <strong className="text-neutral-900 dark:text-amber-200 font-semibold">Piyush Palace</strong> stands as an authentic architectural marvel. Built with magnificent red-sandstone, royal balconies, carved window jalis, and sprawling manicured green lawns, the estate offers an unmatched setting for grand destination weddings and luxury staycations.
            </p>

            {/* Key Highlights Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-white/70 dark:bg-black/40 border border-amber-500/20 hover:border-amber-400/50 transition-colors shadow-sm">
                <Building2 className="w-6 h-6 text-amber-600 dark:text-amber-400 mb-2" />
                <h3 className="font-serif text-base font-semibold text-neutral-900 dark:text-amber-200">Red Sandstone Mansion</h3>
                <p className="text-xs text-neutral-600 dark:text-amber-100/70 mt-1">Multi-story palacial suite building with open terrace balconies and lawn views.</p>
              </div>

              <div className="p-4 rounded-2xl bg-white/70 dark:bg-black/40 border border-amber-500/20 hover:border-amber-400/50 transition-colors shadow-sm">
                <Trees className="w-6 h-6 text-amber-600 dark:text-amber-400 mb-2" />
                <h3 className="font-serif text-base font-semibold text-neutral-900 dark:text-amber-200">Lush Orchard Gardens</h3>
                <p className="text-xs text-neutral-600 dark:text-amber-100/70 mt-1">Sprawling 7-acre green orchards, decorative fountains, and grand event lawns.</p>
              </div>
            </div>

            {/* Bullet Points */}
            <div className="space-y-2.5 pt-2">
              <div className="flex items-center gap-3 text-sm text-neutral-800 dark:text-amber-100/90">
